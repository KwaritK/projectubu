...
const CreateRoomModal = ({ isOpen, closeModal }) => {
  ...
  <button
    ...
    className={`w-full px-4 py-2 border rounded-md hover:bg-gray-100 flex items-center justify-centerrelative w-[48%] rounded-md overflow-hidden transition-all duration-300 ${
