...
import SetUsername from './SetUsername'; // ตรวจสอบให้แน่ใจว่าคุณได้นำเข้า SetUsername

const UserList = ({ users, roomID, onSetUsername }) => {
  ...
  return (
    <div className="user-list mt-4">
      <SetUsername roomID={roomID} onSetUsername={onSetUsername} />
