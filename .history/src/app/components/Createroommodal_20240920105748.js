...
const CreateRoomModal = ({ isOpen, closeModal }) => {
  ...
  <button
    ...
    className={`w-100 px-4 py-2 border rounded-md hover:bg-gray-100 flex items-center justify-center relative w-[48%] rounded-md overflow-hidden transition-all duration-300 ${
