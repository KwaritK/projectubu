...
const CreateRoomModal = ({ isOpen, closeModal }) => {
  ...
  <button
    ...
    className={`  w-[48%] px-4 py-2 border rounded-md flex items-center justify-center
    transition-all duration-300 
    ${
      roomType === 'one-on-one' ? 'bg-blue-500 text-white scale-105' 
  ...
  <button
    ...
    className={`w-[48%] px-4 py-2 border rounded-md flex items-center justify-center
    transition-all duration-300  ${
      roomType === 'multi' ? 'bg-blue-500 text-white scale-105' 
      : 'bg-gray-800 text-gray-300'
    }`}
