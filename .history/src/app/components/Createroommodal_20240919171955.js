      ...
      <Dialog as="div" className="relative z-10" onClose={closeModal}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-3xl h-[580px]  transform overflow-hidden rounded-2x2 bg-white p-8 text-left align-middle shadow-xl transition-all relative">
                <button
                  onClick={closeModal}
                ...
                <button
                  ...
                  className={`relative w-[48%] border rounded-md flex items-center justify-center transition-all duration-300 ${
                    roomType === 'one-on-one' ? 'bg-blue-500' : 'bg-gray-200 scale-90'
                  }`}
                  style={{ height: roomType === 'one-on-one' ? '150px' : '100px' }} // เปลี่ยนขนาดตามการเลือก
                >
                  <Image
                    src={one}
                    alt="คุยแบบตัวต่อตัว"
                ...
                <button
                  ...
                  className={`relative w-[50%] border rounded-md flex items-center justify-center transition-all duration-300 ${
                    roomType === 'multi' ? 'bg-blue-500' : 'bg-gray-200 scale-90'
                  }`}
                  style={{ height: roomType === 'multi' ? '150px' : '100px' }} // เปลี่ยนขนาดตามการเลือก
                >
                  <Image
                    src={multi}
                    alt="คุยแบบกลุ่ม"
