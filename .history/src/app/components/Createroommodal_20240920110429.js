...
const CreateRoomModal = ({ isOpen, closeModal }) => {
  ...
  <button
    ...
    className="w-full w-[40%] px-4 py-2 border rounded-md  flex items-center justify-center"
  >
    <Image
      src={one}
      alt="คุยแบบตัวต่อตัว"
  ...
  <button
    ...
    className="w-full w-[50%] px-4 py-2 border rounded-md  flex items-center justify-center"
  >
    <Image
      src={multi}
      alt="คุยแบบกลุ่ม"
