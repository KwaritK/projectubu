...
import closeIcon from '/public/asset/close-icon.png'; // สมมติว่าคุณมีไอคอนปิดอยู่ในโฟลเดอร์นี้
          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all relative">
                ...
                >
                  <Image src={closeIcon} alt="ปิด" width={20} height={20} />
                </button>
                <Dialog.Title
                  as="h3"
                ...
                <div className="mb-4">
                  <h4 className="text-md font-medium mb-2">เลือกกลุ่มอายุ</h4>
                  <div className="flex justify-between">
                    ...
                    <button
                      ...
                      className={`w-[30%] px-2 py-1 border rounded-md ${ageGroup === 'teen' ? 'bg-blue-500 text-white' : 'hover:bg-gray-100'}`}
                    >
                      วัยรุ่น
                    </button>
                    <button
                      onClick={() => setAgeGroup('adult')}
                      className={`w-[30%] px-2 py-1 border rounded-md ${ageGroup === 'adult' ? 'bg-blue-500 text-white' : 'hover:bg-gray-100'}`}
                    >
                      ผู้ใหญ่
                    </button>
                  </div>
