  ...
  return (
    <div style={{ display: 'flex', height: '60vh', maxWidth: '100%', padding: '20px' }}>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto mb-4 border p-2" style={{ flexDirection: "column-reverse" }}>
        ...
        <button className="mt-4 bg-gray-300 p-2 rounded" onClick={leaveChat}>กลับ
</button>
