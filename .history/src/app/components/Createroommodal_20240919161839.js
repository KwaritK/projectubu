...
import one from '/public/asset/logbut.png'; 
import multi from '/public/asset/regisbut.png'; 
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-4 space-y-4">
                  ...
                  >
                    <Image src="/multi.png" alt="คุยแบบตัวต่อตัว" width={300} height={100} />
                    <span>one one</span>
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2 border rounded-md hover:bg-gray-100 flex items-center justify-center"
                  >
                    <Image src="/multi.png" alt="คุยแบบกลุ่ม" width={300} height={100} />
