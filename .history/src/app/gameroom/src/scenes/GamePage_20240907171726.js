export default class GamePage extends Phaser.Scene {
    ...
    preload() {
        this.load.image('girl', '/asset/imageG/girl.png');
        this.load.image('ball', '/asset/imageG/fire.png');
        this.load.image('bigboy', '/asset/imageG/bigboy.png');
        this.load.image('effect1', '/asset/imageG/effect1.png');
        this.load.image('effect2', '/asset/imageG/effect2.png');
        this.load.image('money', '/asset/imageG/money.png');
        this.load.image('Heart', '/asset/imageG/Heart.png');
    ...
    create() {
        ...
        let scoreBackground = this.add.rectangle(1200, 50, 150, 50, 0x000000, 0.5);
