export default class GameOverPage extends Phaser.Scene {
    ...
    create() { // รับ data เป็นพารามิเตอร์
       ...
       // watermark.setAlpha(0.6); // ความโปร่งใส
        ...
        this.add.text(400, 100, 'Game Over', { fontSize: '72px', fill: '#000' ,fontFamily: 'Arial' }).setOrigin(0.5);
        this.add.text(400, 150, 'Score: ' + this.score, { fontSize: '56px', fill: '#000',fontFamily: 'Arial' }).setOrigin(0.5);
