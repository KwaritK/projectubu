export default class Game extends Phaser.Scene {
  ...
  preload() {
      ...
      this.load.atlas('dodgh','/asset/imageR/run22.png','/asset/imageR/run22.json')
      ...
      this.load.atlas('snakeground','/asset/imageR/snakeground.png','/asset/imageR/snakegroundo.json')
