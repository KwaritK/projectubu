export default class Game extends Phaser.Scene {
  ...
  this.physics.add.existing(this.ground, true);
      ...
      this.enemy = this.physics.add.sprite(250, 250, 'enemy');
      
      //this.enemy.setCollideWorldBounds(true);
      //this.enemy.y = this.ground.y - this.enemy.height / 2.5;
      this.enemy.y = this.ground.y - this.ground.height / 2 - this.enemy.displayHeight / 2;
      this.enemy.setScale(0.9);
      this.enemy.setSize(this.enemy.width * 0.2, this.enemy.height * 0.2);
