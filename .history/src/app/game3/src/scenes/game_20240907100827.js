export default class Game extends Phaser.Scene {
  ...
  preload() {
      ...
      this.load.atlas('enemy','/asset/imageR/enemy00.png','/asset/imageR/enemy00.json')
      this.load.atlas('obst','/asset/imageR/enemy00.png','/asset/imageR/enemy00.json')
  ...
  this.scoreText.setDepth(10);
      ...
      this.anims.create({
        key: 'enemy',
        frames: [
          { key: 'enemy', frame: 'enemy4.png' },
          { key: 'enemy', frame: 'enemy3.png' },
          { key: 'enemy', frame: 'enemy5.png' }
        ],
        frameRate: 5,
        repeat: -1
      });
