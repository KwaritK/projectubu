export default class GameOverPage extends Phaser.Scene {
    ...
    create() { // รับ data เป็นพารามิเตอร์
        ...
        watermark.setAlpha(0.4); // ความโปร่งใส
        
        this.add.text(400, 300, 'Game Over', { fontSize: '64px', fill: '#000' ,fontWeight: 'Bold', }).setOrigin(0.5);
        this.add.text(400, 350, 'Score: ' + this.score, { fontSize: '48px', fill: '#000',fontWeight: 'Bold', }).setOrigin(0.5);
