export default class AgainPage extends Phaser.Scene {
    ...
    preload() {
        this.load.image('butagin', '/asset/imageR/export default class GameOverPage extends Phaser.Scene {
    constructor() {
        super('GameOverPage');
    }
...
.png'); // Adjust the path if needed
        this.load.image('again', '/asset/imageR/end.png'); // Load your background image
