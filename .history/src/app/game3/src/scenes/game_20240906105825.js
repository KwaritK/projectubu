...
duck() {
        if (this.player && !this.isDucking && this.anims.exists('dodgh')) {
          ...
          this.player.setScale(0.5, 0.5); c:\Users\User\AppData\Local\Packages\MicrosoftWindows.Client.CBS_cw5n1h2txyewy\TempState\ScreenClip\{A202A492-55B6-4DDD-8F36-E7354D4BA9B5}.png
        }  
