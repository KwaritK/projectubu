export default class Game extends Phaser.Scene {
  ...
  preload() {
      ...
      this.load.atlas('ene', '/asset/imageR/die.png', '/asset/imageR/die.json');
  ...
  this.physics.add.existing(this.ground, true);
      ...
      //this.enemy.y = this.ground.y - this.enemy.height / 2.5;
      this.enemy.y = this.ground.y  - this.enemy.displayHeight / 2;
      ...
      this.physics.add.เป็นการใช้ฟังก์ชัน preload เพื่อเตรียมองค์ประกอบรูปภาพต่างๆ
      บรรทัดที่ 44 เป็นการสร้างฟังก์ชัน create เพื่อสร้างฉากตัวละครการกระทำต่างๆแสดง UI
...
this.lastObstacleTime = currentTime;
      ...
      createob1() {
          const ob1 = this.ob1.create(800,  490, 'ob1');
