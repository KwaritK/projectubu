  ...
  this.physics.add.existing(this.ground, true);
      ...
      //this.originalHitboxWidth = this.player.body.width;
        //this.originalHitboxHeight = this.player.body.height;
          ...
          this.enemy.body.setSize(hitboxWidth, hitboxHeight);
          this.enemy.body.setOffset((this.player.displayWidth - hitboxWidth) / 2, this.player.displayHeight - hitboxHeight);
