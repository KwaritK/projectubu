...
const WelcomePage = () => {
  ...
  const [hasUsername, setHasUsername] = useState(false); // เพิ่ม state สำหรับจัดการชื่อผู้ใช้
  ...
  const handleUsernameSubmit = (username) => {
    // คุณสามารถบันทึกชื่อผู้ใช้ที่ได้จาก SetUsername ไว้ใน session หรือใน state
    console.log("Username set:", username);
    setHasUsername(true); // ตั้งค่าว่าผู้ใช้ตั้งชื่อแล้ว
  };
    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="container mx-auto py-5 px-4">
        <div className="bg-white border-2 border-gray-300 rounded-lg p-6 max-w-4xl mx-auto">
          ...
          {!hasUsername ? (
            // แสดง SetUsername component ถ้าผู้ใช้ยังไม่ได้ตั้งชื่อ
            <SetUsername onSetUsername={setUsername}{handleUsernameSubmit} />
          ) : (
            // ถ้าผู้ใช้ตั้งชื่อแล้ว ให้แสดงส่วนการเข้าร่วมห้อง
