...
const WelcomePage = () => {
  ...
  useEffect(() => {
    ...
    if (storedUsername) {
      ...
      router.push('/chatroom'); // เมื่อมีชื่อแล้วให้ไปหน้าห้องสนทนา
    }
  }, []);
  ...
  const handleSetUsername = (name) => {
    ...
    router.push('/chatroom'); // เมื่อกำหนดชื่อแล้วให้ไปหน้าห้องสนทนา
  };
  if (!username) {
    return <SetUsername onSetUsername={handleSetUsername} />;
  }

  return null; // ถ้ามีชื่อแล้ว ไม่ต้องทำอะไรเพราะจะเปลี่ยนหน้าแล้ว
}
