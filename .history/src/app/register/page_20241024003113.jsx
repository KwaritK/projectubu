      ...
      <Image src={titleImage} alt="title" className="mx-auto"/>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className=' mb-4'>
              ...
              <input onChange={(e) => setConfirmPassword(e.target.value)} className='block bg-gray-300 p-1 ml-2 rounded-md inline-block' type="password" placeholder='ยืนยันรหัสผ่านอีกครั้ง' />
            </div>
