...
function RegisterPage() {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        if (!resCheck.ok) {
            throw new Error(`ข้อผิดพลาด HTTP! สถานะ: ${resCheck.status}`);
        }
        ...
        if (!res.ok) {
            throw new Error(`ข้อผิดพลาด HTTP! สถานะ: ${res.status}`);
        }
        ...
        setError("เกิดข้อผิดพลาดในการลงทะเบียน โปรดลองอีกครั้งในภายหลัง");
    }
};
  return (
