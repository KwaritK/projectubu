export default class GameOverPage extends Phaser.Scene {
    ...
    preload() {
        this.load.image('but', 'assets/but.png'); // Adjust the path if needed
        this.load.image('end', 'assets/end.png'); // Load your background image
    ...
    create() { // รับ data เป็นพารามิเตอร์
        ...
        const restartButton = this.add.sprite(400, 500, 'but').setInteractive();
