export default class GameOverPage extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('ovback', '/asset/imageG/ove.png'); // Load your background image
    ...
    create(data) { // รับ data เป็นพารามิเตอร์
        ...
        //แสดงคะแนน
        this.add.text(700, 150, 'Score: ' + data.score, { fontSize: '64px', fill: '#000' ,fontFamily:'Arial'}).setOrigin(0.5); // แสดงคะแนน
    }
